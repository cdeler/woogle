...
if __name__ == "__main__":
    ...
    parser.add_argument('-l', '--language', help=f'wikipedia language (default: {CHOICE_LANGUAGE[0]})', type=str,
                        choices=CHOICE_LANGUAGE, default=CHOICE_LANGUAGE[0])
    parser.add_argument('-o', '--output', help=f'output (default: {CHOICE_OUTPUT[0]})', type=str, choices=CHOICE_OUTPUT,
